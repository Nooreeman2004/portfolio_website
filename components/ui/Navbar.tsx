        ...
        <div className="glass rounded-full px-6 py-3 flex items-center justify-between w-full max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className={`text-sm uppercase tracking-wider transition-all duration-300 ${activeSection === 'contact'
            ...
            <div className="flex flex-col gap-4">
              {['About', 'Experience', 'Skills', 'Projects', 'Research', 'Awards', 'Community'].map((title) => (
                <button
                  ...
                  className={`text-left text-lg uppercase tracking-wider ${activeSection === title.toLowerCase()
                    ? 'text-white font-semibold'
                    : 'text-secondary'
                    }`}
                >
