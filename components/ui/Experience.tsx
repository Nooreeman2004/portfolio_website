        ...
        {volunteer.length > 0 && (
          <div className="mt-20">
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-white">Volunteer Experience</h2>
            </motion.div>
            ...
            <div className="relative">
              ...
              <div className="space-y-8">
                {volunteer.map((vol, index) => (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div className="absolute left-[19px] md:left-[27px] top-0 w-4 h-4 rounded-full bg-accent border-4 border-primary z-10" />

                    {/* Content Card */}
                    <div className="bg-tertiary/40 backdrop-blur-sm p-5 sm:p-6 rounded-2xl border border-secondary/20 hover:border-secondary/40 transition-all duration-300 hover:shadow-lg hover:shadow-secondary/5">
                      <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                        {/* Organization Icon (Placeholder) */}
                        <div className="w-14 h-14 bg-accent/20 rounded-xl flex items-center justify-center flex-shrink-0 border border-accent/20">
                        ...
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-2 mb-2">
                            <h3 className="text-white font-semibold text-lg">{vol.title}</h3>
                            <span className="text-secondary">@</span>
                            <span className="text-secondary font-medium">{vol.organization}</span>
                          </div>

                          {/* Date */}
                          <div className="flex items-center gap-2 text-secondary/70 mb-4">
                            <Calendar className="w-4 h-4" />
                            <p className="text-sm">{vol.date}</p>
                          </div>
